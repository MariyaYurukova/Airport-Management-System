...
import airportmanagement.system.service.PlaneService;
...
public class HomeController  extends BaseController {
    ...
    @Autowired
    public HomeController(AirlineService airlineService, ModelMapper modelMapper, AirportService airportService, PlaneService planeService) {
    ...
    @ResponseBody
    public ResponseEntity<Object> addPlane(@RequestBody PlaneServiceModel planeServiceModel) {
        planeService.addPlane(planeServiceModel);
        MyResponse<PlaneServiceModel> response = new MyResponse<>("success", planeServiceModel);
        return new ResponseEntity<Object>(response, HttpStatus.OK);
    }
